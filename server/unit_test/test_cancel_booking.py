...
def test_cancel_booking_makes_db_call(mocker):
  mock = mocker.patch('services.booking_service.BookingService.cancel_booking', return_value = [])
  _ = bookingService.cancel_booking()
  assert mock.call_count == 1


def test_cancel_booking(mocker):
    mock = mocker.patch('services.booking_service.BookingService.cancel_booking', return_value = result)
